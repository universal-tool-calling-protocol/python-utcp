"""Embedding-based semantic search strategy for UTCP tools.
...
class EmbeddingSearchStrategy(ToolSearchStrategy):
    """Semantic search strategy using sentence embeddings.
    ...
    tool_search_strategy_type: Literal["embedding_search"] = "embedding_search"
...
class EmbeddingSearchStrategyConfigSerializer(Serializer[EmbeddingSearchStrategy]):
    """Serializer for EmbeddingSearchStrategy configuration."""
    
    def to_dict(self, obj: EmbeddingSearchStrategy) -> dict:
        return obj.model_dump()
    
    def validate_dict(self, data: dict) -> EmbeddingSearchStrategy:
        try:
            return EmbeddingSearchStrategy.model_validate(data)
        except Exception as e:
